    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-file-text-o"></i></i>Perguta Ouvinte</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="<?= URL_RAIZ ?>/home">Home</a></li>
                            <li><i class="fa fa-ey "></i>Ver Conteúdo</li>
                            <li><i class="fa fa-question"></i>Pergunta ouvinte</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div id="pageImagem" class="tab-pane active">
                                        <div class="profile-activity">
                                            ...
                                            <table id="tabela" class="table table-hover table-striped" data-url="<?= URL_RAIZ ?>/resources/dataTables_traducao.txt">
                                                ...
                                                <tbody id="tbody" data-url="<?= URL_RAIZ ?>/pergunta-ouvinte">
                                                    <?php
                                                    ...
                                                    $daopergunta->showPerguntaUsuarioEquipe(array('id_usuario' => $info[2], 'tb_equipe_id_equipe' => $id_equipe, 'tato_ou_ouvinte' => $valor_ouvinte));

                                                    if ($daopergunta->getRowCount() > 0) {
                                                        foreach ($daopergunta->getResult() as $pergunta) :
                                                            if ($pergunta['tato_ou_ouvinte'] == 1) {
                                                                ?>
                                                                <tr>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.fa-eye', function() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: "id=" + id_recuperado + "&action=viewPerguntaOuvinte",
                success: function(resultado) {
                    if (resultado) {

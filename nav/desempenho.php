                ...
                if ($('#id_quiz').val() !== '' && $('#id_paciente').val() !== '') {
                    ...
                    setTimeout(function() {
                        $.ajax({
                            ...
                            type: "POST",
                            data: $("#form-get-dados").serialize() + "&action=getGrafico",
...
<script >
  function dadosGrafico(result) {
      console.log(result.mediaPaciente);
   ...
   Highcharts.chart('grafico', {
        ...
        title: {
            text: 'Média de acertos no quiz: '+ result.cod_quiz
        },
        subtitle: {
            text: 'descrição'
        },
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [{
                    name: "Média de acerto do paciente " + result.nomePaciente,
                    y:result.mediaPaciente,
                    drilldown: "Chrome"
                },
                {
                    name: "Média de acerto de todos os pacientes",
                    y: result.mediaGeral,
                    drilldown: null
                }
            ]

    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-plus"></i></i>Adicionar paciente a um quiz</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="<?= URL_RAIZ ?>/home">Home</a></li>
                            <li><i class="fa fa-gamepad">Adicionar</i></li>
                            <li><i class="fa fa-plus"></i>paciente</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                                ...
                                                <tbody id="tbody" data-url="<?= URL_RAIZ ?>/quiz">
                                                    ...
                                                    if ($daoquiz->getRowCount() > 0) {
                                                        foreach ($daoquiz->getResult() as $quiz) :
                                                            ...
                                                            echo "<td class='mod'><a href='".URL."/add-jogador/{$quiz['id_quiz']}'><i class='icon_plus btn btn-primary'></i></a></td>";                                                     
                                                            echo '</tr>';
                                                        endforeach;
                                                    }
                                                    ?>
